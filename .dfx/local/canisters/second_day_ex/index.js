...
import { idlFactory } from './second_day_ex.did.js';
export { idlFactory } from './second_day_ex.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.SECOND_DAY_EX_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./second_day_ex.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the second_day_ex canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./second_day_ex.did.js")._SERVICE>}
 */
export const second_day_ex = createActor(canisterId);
