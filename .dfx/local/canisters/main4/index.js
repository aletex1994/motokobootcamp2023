...
import { idlFactory } from './main4.did.js';
export { idlFactory } from './main4.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.MAIN4_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./main4.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the main4 canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./main4.did.js")._SERVICE>}
 */
export const main4 = createActor(canisterId);
