...
import { idlFactory } from './first_day_ex.did.js';
export { idlFactory } from './first_day_ex.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.FIRST_DAY_EX_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./first_day_ex.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the first_day_ex canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./first_day_ex.did.js")._SERVICE>}
 */
export const first_day_ex = createActor(canisterId);
